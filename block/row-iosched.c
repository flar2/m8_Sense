...
/* Try to modify dispatch quantum while requests is over expired time,
   and waiting requests is over threshold. */
#define EXPIRE_REQUEST_THRESHOLD       20

	/* Only modify regular class. The default quantum of
	   ROWQ_PRIO_REG_READ is 100 and it's slightly too much. */

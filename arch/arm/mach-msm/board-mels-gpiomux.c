...
#if 0	/* gpio144 in mesl is for NFC_IRQ pin instaed of HSIC_STROBE */
...
static struct gpiomux_setting cam_settings[] = {
	...
	{
		.func = GPIOMUX_FUNC_1, /*active 24 - A FUNC1 6MA*/
		.drv = GPIOMUX_DRV_6MA,
		.pull = GPIOMUX_PULL_NONE,
	},

	{
		.func = GPIOMUX_FUNC_GPIO, /*active 25 - O(L) 6MA*/
		.drv = GPIOMUX_DRV_6MA,
		.pull = GPIOMUX_PULL_NONE,
		.dir = GPIOMUX_OUT_LOW,
	},
...
static struct msm_gpiomux_config msm_sensor_configs[] __initdata = {
	{
		.gpio = 15, /* CAM_MCLK0 */
		.settings = {
			[GPIOMUX_ACTIVE]    = &cam_settings[24], /*A FUNC1 6MA*/
			[GPIOMUX_SUSPENDED] = &cam_settings[25], /*O(L) 6MA*/
		},
	},
	{
		.gpio = 16, /* CAM_MCLK1 */
